...
module HDMI_QSYS_mm_interconnect_0 (
	...
	wire   [9:0] cmd_mux_002_src_channel;                                                          // cmd_mux_002:src_channel -> nios2_qsys_debug_mem_slave_agent:cp_channel
	...
	wire   [9:0] cmd_mux_003_src_channel;                                                          // cmd_mux_003:src_channel -> timer_s1_agent:cp_channel
	...
	wire   [9:0] cmd_mux_005_src_channel;                                                          // cmd_mux_005:src_channel -> i2c_sda_s1_agent:cp_channel
	...
	wire   [9:0] cmd_mux_006_src_channel;                                                          // cmd_mux_006:src_channel -> i2c_scl_s1_agent:cp_channel
	...
	wire   [9:0] cmd_mux_008_src_channel;                                                          // cmd_mux_008:src_channel -> hdmi_tx_int_n_s1_agent:cp_channel
	...
	wire   [9:0] cmd_mux_009_src_channel;                                                          // cmd_mux_009:src_channel -> position_s1_agent:cp_channel
	...
	wire  [98:0] rsp_demux_009_src0_data;                                                          // rsp_demux_009:src0_data -> crosser_001:in_data
	wire         rsp_demux_009_src0_ready;                                                         // crosser_001:in_ready -> rsp_demux_009:src0_ready
	wire   [9:0] rsp_demux_009_src0_channel;                                                       // rsp_demux_009:src0_channel -> crosser_001:in_channel
	...
	wire  [98:0] crosser_001_out_data;                                                             // crosser_001:out_data -> rsp_mux:sink9_data
	wire         crosser_001_out_ready;                                                            // rsp_mux:sink9_ready -> crosser_001:out_ready
	wire   [9:0] crosser_001_out_channel;                                                          // crosser_001:out_channel -> rsp_mux:sink9_channel
