...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../C5G_HDMI_VPG.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../HDMI_QSYS.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1010a0
SOPC_SYSID_FLAG += --sidp=0x1010a0
ELF_PATCH_FLAG  += --sidp 0x1010a0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1542648420
SOPC_SYSID_FLAG += --timestamp=1542648420
ELF_PATCH_FLAG  += --timestamp 1542648420
